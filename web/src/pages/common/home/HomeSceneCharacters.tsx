/** 左 · 奶龙 Q 版 */
export function NailongCharacter() {
  return (
    <svg viewBox="0 0 400 480" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      ...
      <g className="home-scene__nailong-tail">
        <path d="M92 310c-28 36-38 82-24 120 16 44 58 68 96 52 22-10 38-30 44-54" fill="#84cc16" />
      ...
      <g className="home-scene__nailong-face">
        ...
        <path d="M178 268 Q200 284 222 268" stroke="#ca8a04" strokeWidth="4.5" strokeLinecap="round" fill="none" />
      </g>
      <g className="home-scene__nailong-wave">
        ...
        <path d="M286 288c8-14 22-18 32-10" stroke="#fde047" strokeWidth="16" strokeLinecap="round" />
      </g>
    </svg>
  )
}
...
/** 右 · 牛牛 Q 版 */
export function NiuniuCharacter() {
  return (
    <svg viewBox="0 0 400 480" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
      <ellipse cx="200" cy="456" rx="108" ry="15" fill="rgba(88,28,135,0.32)" />
      ...
      <g className="home-scene__niuniu-face">
        ...
        <path d="M184 278 Q200 288 216 278" stroke="#e11d48" strokeWidth="3.5" strokeLinecap="round" fill="none" />
      </g>
      <g className="home-scene__niuniu-wave">
        <ellipse cx="102" cy="302" rx="20" ry="18" fill="#fff7ed" />
        <path d="M114 290c-8-14-22-18-32-10" stroke="#fff7ed" strokeWidth="16" strokeLinecap="round" />
      </g>
    </svg>
  )
}
