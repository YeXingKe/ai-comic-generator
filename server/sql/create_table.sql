...
(
    ...
    phase           varchar(50)  default 'PENDING'        not null comment '当前阶段：PENDING/STORY_IDEATION/CHARACTER_DESIGN/STORYBOARD_SCRIPT/IMAGE_GENERATION/LAYOUT_COMPOSE/WECHAT_PUBLISH',
