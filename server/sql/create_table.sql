...
(
    ...
    captionTextMode     varchar(20)  default 'top'             not null comment '文案展示模式：none/top/bubble',
    panelCount      int          default 4                 not null comment '分镜格数 4/6/8',
    ...
    status          varchar(20)  default 'PENDING'        not null comment '任务状态：PENDING/PROCESSING/AWAITING_CONFIRM/TITLE_CONFIRMED/AWAITING_STORYBOARD/COMPLETED/FAILED',
